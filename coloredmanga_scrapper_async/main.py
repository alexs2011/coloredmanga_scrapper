...
def main():
    ...
    file_contents = "..\\coloredmanga_scrapper_async\\data\\contents_full.json"
    ...
    # Скачивание манги.
    utils.download_manga(manga_contents, dir_root, start_with=94, end_with=95, is_flatten=True)
